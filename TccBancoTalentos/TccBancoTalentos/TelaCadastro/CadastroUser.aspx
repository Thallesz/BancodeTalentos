            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="row-mb-3" style="margin-left: 50px">
                        ...
                        <h2 style="font-size: 16px; color: #2B4691; cursor: default">Currículo:</h2>
                        <asp:FileUpload runat="server" ID="oFile" AllowMultiple="false" accept=".pdf" />
                        <asp:Label runat="server" ID="lblConfirmCurriculo"></asp:Label>
                    </div>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="row-mb-3" style="margin-left: 50px">
                        ...
                        <asp:DropDownList runat="server" ID="droplistEstado" AutoPostBack="true" CssClass="dropdownlist" OnSelectedIndexChanged="droplistEstado_SelectedIndexChanged" Style="text-align: initial; border-radius: 0px; border-color: #ced4da; width: 447px"></asp:DropDownList>
                        <h2 style="font-size: 16px; color: #2B4691; cursor: default">CIDADE:</h2>
                        <asp:DropDownList runat="server" ID="droplistCidade" AutoPostBack="false" CssClass="dropdownlist" Style="text-align: initial; border-radius: 0px; border-color: #ced4da; width: 447px"></asp:DropDownList>
                    </div>
                </div>
            </div>
        </div>
