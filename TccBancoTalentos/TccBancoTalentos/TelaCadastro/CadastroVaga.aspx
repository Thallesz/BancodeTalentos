            ...
            <div style="border: none; border-color: black; padding: 58px; border-radius: 0px; background-color: #F8F9FA;margin-bottom:140px">
                <div class="row">
                    ...
                    <div class="col-sm-4">                        
                        ...
                        <asp:DropDownList runat="server" ID="droplistEstado" AutoPostBack="true" CssClass="dropdownlist" OnSelectedIndexChanged="droplistEstado_SelectedIndexChanged" placeholder="SELECIONE O ESTADO" Style="text-align: initial; border-radius: 0px; border-color: #ced4da"></asp:DropDownList>
                        <h2 style="font-size: 16px; color: #2B4691; cursor: default">CIDADE:</h2>
                        <asp:DropDownList runat="server" ID="droplistCidade" AutoPostBack="false" CssClass="dropdownlist" Style="text-align: initial; border-radius: 0px; border-color: #ced4da"></asp:DropDownList>                      
                    </div>
                </div>
            </div>
        </div>
