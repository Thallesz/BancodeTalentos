...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-principal">           
        <div class="row">
            <div style="border: none; border-color: black; padding: 60px; margin-top: 50px; border-radius: 50px; box-shadow: 10px 10px 20px #030303">
                <div class="row">
                    <div class="col-sm-2"></div>
                    <div class="col-sm-3">
                        <h2 style="font-size: 20px; color: black">Nome:</h2>
                        ...
                        <h2 style="font-size: 20px; color: black">CPF:</h2>
                        ...
                        <h2 style="font-size: 20px; color: black">RG:</h2>
