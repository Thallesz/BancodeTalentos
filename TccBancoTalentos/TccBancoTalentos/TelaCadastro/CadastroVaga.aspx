...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="border: solid; border-color: black; padding: 60px; margin-top: 110px; border-radius: 50px">
        <div class="row">
                ...
                <div class="col-sm-2">
                    <asp:Button runat="server" ID="btnRegistar" CssClass="btn btn-success" Text="Registrar" Style="margin-left: 10px; border-radius: 50px; margin-top: 320px" Font-Size="20px" Width="150px" Height="40px" />                    
                </div>
                <div class="col-sm-4">
